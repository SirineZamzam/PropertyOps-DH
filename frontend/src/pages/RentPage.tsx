...
function OwnerRent() {
  ...
  async function remove(
    ...
    const confirmed =
      await confirmAction({
        title:
          "Delete this pending obligation?",

        text:
          "Only pending obligations may be deleted.",
...
function CreateRentForm({
  ...
  async function submit(
    ...
    if (
      ...
      setEmailError(
        "Enter the tenant's registered email.",
      );
      return;
    }
