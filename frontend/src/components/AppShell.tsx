...
import { OwnerPlanBadge } from "./OwnerPlanBadge";
...
export function AppShell() {
  ...
  const [theme, setTheme] = useState<Theme>(() => {
    return localStorage.getItem("propertyops_dashboard_theme") === "dark"
      ? "dark"
      : "light";
  });

  useEffect(() => {
    localStorage.setItem("propertyops_dashboard_theme", theme);
  }, [theme]);
  ...
  const adminNavigation = [
    ...
    },
    {
      ...
      to: "/app/admin/subscription-payments",
      icon: WalletCards,
    },
    {
      label: "Settings",
  ...
  const accountLabel = user?.first_name
    ...
    >
      ...
      >
        ...
        <div className="mt-auto space-y-2 p-3">
          {user?.role === "OWNER" && <OwnerPlanBadge collapsed={collapsed} />}
